...
public class FirstiOSTest {
    ...
    public void handleNotificationsPermissionPopUp() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(new AppiumBy.ByAccessibilityId("Don’t Allow")));
        driver.findElement(By.id("Don’t Allow")).click();
    }

    public void basicSetWebViewContext(String neededContext2) {
        String[] contextNames2 = driver.getContextHandles().toArray(new String[0]);
        for (int i = 0; i < contextNames2.length; i++) {
           driver.context(contextNames2[i]);
           if (driver.getTitle().equals(neededContext2)) {
               break;
           }
        }
    }

    public void setWebViewContext(String neededContext) {
        ArrayList<Map<String,String>> contextNames = (ArrayList<Map<String, String>>) driver.executeScript("mobile:getContexts", ImmutableMap.of("waitForWebviewMs","10000"));
        for (Map<String, String> contextName : contextNames) {
            System.out.println(contextName.get("title"));
            if(Objects.equals(contextName.get("title"), neededContext)){
                webContext = contextName.get("id");
                break;
            }
        }
    }
    ...
    private void LoginWithRememberMe() {
        ...
        driver.findElement(By.id("usernameInputView")).sendKeys("kirilovstgguru2");
        driver.findElement(By.id("usernameInputView")).sendKeys(Keys.chord(Keys.CONTROL + "A"));
        driver.findElement(By.id("usernameInputView")).sendKeys(Keys.chord(Keys.DELETE));
        driver.findElement(By.id("usernameInputView")).sendKeys("kirilovstgguru2");
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("passwordInputView"))).isDisplayed());
        driver.findElement(By.id("passwordInputView")).click();
        driver.findElement(By.id("passwordInputView")).clear();
        driver.findElement(By.id("passwordInputView")).sendKeys("MyTest123!");
    ...
    public void Login() {
        ...
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("usernameInputView"))).isDisplayed());
        driver.findElement(By.id("usernameInputView")).click();
        driver.findElement(By.id("usernameInputEditText"))
                .sendKeys("kirilovstgguru2");
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("passwordInputView"))).isDisplayed());
        driver.findElement(By.id("passwordInputView"))
                .click();
        driver.findElement(By.id("passwordInputEditText")) // need ID for the text field of the Password field
                .sendKeys("MyTest123!");
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("loginButton"))).isEnabled());
    ...
    private void Logout() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("AccountIcon"))).click();
...
//        accountGridElements.get(2).click();
        ...
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("Log in"))).isDisplayed());
    }
    ...
    public void setUp() throws MalformedURLException {
        ...
        caps.setCapability("xcodeSigningId", "Apple Distribution");
        ...
        caps.setCapability("app","/Users/ivankirilov/IdeaProjects/TestAutomationTaskIvanKirilov/IvanAutomation/apps/GuruPlay STG.ipa");
    ...
    public void LoginWithRememberMeFunctionality() {
        ...
        LoginWithRememberMe();
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("AccountIcon"))).isDisplayed());
        killAndRelaunchApp("com.india.guruplay");
        driver.findElement(By.id("loginButton")).click();
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("AccountIcon"))).isDisplayed());
        Logout();
        Assert.assertTrue(driver.findElement(By.id("Log in")).isDisplayed());
    }
...
//        String amount = driver.findElement(By.id("headerAmount")).getText();
        ...
        driver.findElement(By.xpath("//*[@data-uat='deposit-Amount *-field']")).sendKeys(Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE);
        driver.findElement(By.xpath("//*[@data-uat='deposit-Amount *-field']")).sendKeys(Keys.DELETE);
        driver.findElement(By.xpath("//*[@data-uat='deposit-Amount *-field']")).sendKeys("50");
        driver.hideKeyboard();
...
//        Assert.assertNotEquals(amount, updatedAmount);
    ...
    public void NavigationThroughBottomNavigationTabs() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("headerLogin")));
        killAndRelaunchApp("com.india.guruplay");
        wait.until(ExpectedConditions.visibilityOfElementLocated(new AppiumBy.ByAccessibilityId("Sports")))
                .click();
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(new AppiumBy.ByAccessibilityId("Top Games"))).isDisplayed());
        driver.findElement(new AppiumBy.ByAccessibilityId("Casino")).click();
        driver.context(webContext);
        ...
        driver.context(nativeContext);
        driver.findElement(new AppiumBy.ByAccessibilityId("Live Casino")).click();
        driver.context(webContext);
        ...
        driver.context(nativeContext);
        driver.findElement(new AppiumBy.ByAccessibilityId("Offers")).click();
        driver.context(webContext);
        ...
        driver.context(nativeContext);
        driver.findElement(new AppiumBy.ByAccessibilityId("Discover")).click();
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(new AppiumBy.ByAccessibilityId("Download The App"))).isDisplayed());
    }
    ...
    public void FooterOverview() {
        ...
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(new AppiumBy.ByAccessibilityId("Connection is secure. Site information"))).isDisplayed());
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(new AppiumBy.ByAccessibilityId("Close tab"))).isDisplayed());
        driver.findElement(new AppiumBy.ByAccessibilityId("Close tab")).click();
        Assert.assertTrue(wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("linksRecyclerView"))).isDisplayed());
    }
    ...
    public void MultipleTabsPagesNavigation() {
        ...
        driver.context(nativeContext);
        driver.findElement(new AppiumBy.ByAccessibilityId("Free Bets")).click();
        driver.context(webContext);
        ...
        driver.context(nativeContext);
        driver.findElement(new AppiumBy.ByAccessibilityId("Free Spins")).click();
        driver.context(webContext);
        ...
        driver.context(nativeContext);
        driver.findElement(new AppiumBy.ByAccessibilityId("Bonus History")).click();
        driver.context(webContext);
    ...
    public void SocialLinksVerification() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(new AppiumBy.ByAccessibilityId("Close tab")));
        driver.findElement(new AppiumBy.ByAccessibilityId("Close tab")).click();
